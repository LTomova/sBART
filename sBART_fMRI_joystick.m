...
% this task runs all 6 runs at once (button press stops break between runs)
% command to start sBART: sBART_fMRI_joystick;
...
count=0;
for run = 1:6
    %create cond order (4 random permutations 1,2,3)
    condpm=randperm(3);
    ...
    text1 =[ 'Individual round. Run ', num2str(run),' of 6'];
